 const num = 99999999999999999 //number of times spam gets banned -1, for example 5 times 6 times will get banned
const timee = 1 // During `timee` spam `num` times will be banned
